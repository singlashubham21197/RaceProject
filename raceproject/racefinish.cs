...
namespace raceproject
{
    partial class MainForm
    {
        ...
        {
            switch (who) // which horse won
            {
                case (0):
                    horseWonLbl.Text = ("Victory to the Trumpenreich!");
                    MessageBox.Show("hail trump");
                    break;
                case (1):
                    horseWonLbl.Text = ("Victory to the Russian Federation");
                    MessageBox.Show("hail putin");
                    break;
                case (2):
                    horseWonLbl.Text = ("Victory to the moderate rebels");
                    MessageBox.Show("moderate victory");
                    break;
                case (3):
                    horseWonLbl.Text = ("Victory to the extremist rebels");
